          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="border border-white/5 p-4 hover:border-[#FF2C2C]/20 transition-colors">
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-[#F4F1EA]/45 mono mb-2">
                <TipLabel termKey="faithTension">Faith Tension Index</TipLabel>
              </div>
            ...
            <div className="border border-white/5 p-4 hover:border-[#FF2C2C]/20 transition-colors">
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-[#F4F1EA]/45 mono mb-2">
                <TipLabel termKey="miracleFrequency">Miracle Frequency</TipLabel>
              </div>
                ...
                <div className="border border-white/5 p-4 hover:border-[#FF2C2C]/20 transition-colors">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="text-right">
                      <div className="text-[9px] font-black uppercase tracking-[0.2em] text-[#F4F1EA]/40 mono mb-1">
                        <TipLabel termKey="heresyLevel">Heresy</TipLabel>
                      </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[#F4F1EA]/40 mono">
                        <TipLabel termKey="divineInfluence">Influence</TipLabel>
                      </span>
