  ...
  return (
    <div className="space-y-10 relative">
      <StaggeredItem index={0}>
        <section>
          <div className="text-[9px] font-black uppercase tracking-[0.4em] text-[#FF2C2C] mono mb-4 animate-glitch">Defense Overview</div>
      ...
      <StaggeredItem index={1}>
        <section>
          <div className="text-[9px] font-black uppercase tracking-[0.4em] text-[#FF2C2C] mono mb-4">Defense Nodes</div>
                ...
                <div className="border border-white/5 p-4 hover:border-[#FF2C2C]/20 transition-colors">
                  <div className="flex justify-between items-center mb-3">
                    <div>
                      ...
                      <span className="text-[8px] font-bold uppercase text-[#F4F1EA]/25 mono ml-2">{node.type}</span>
                    </div>
                    <span className={`text-[10px] font-black mono ${node.integrity > 80 ? 'text-[#88E788]' : node.integrity > 50 ? 'text-[#FFB800]' : 'text-[#FF2C2C]'}`}>
