    ...
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none select-none">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="relative z-10 text-center">
          <div className="six-caps text-[14rem] text-[#666666] opacity-20 uppercase tracking-[0.1em] leading-[0.85]">
            REALM<br />UNCHARTED
          </div>
          <div className="mt-4 flex items-center justify-center gap-6">
            <div className="h-[1px] w-20 bg-[#FF2C2C]/30" />
            <div className="mono text-[10px] font-black text-[#FF2C2C] tracking-[0.5em] uppercase opacity-40">
      ...
      <div className="absolute top-10 left-10 text-left">
        <div className="flex items-center gap-2 mb-1">
          ...
          <div className="mono text-[10px] font-black text-[#FF2C2C] uppercase tracking-widest">Archive: Ready</div>
        </div>
        <div className="mono text-[8px] text-white/20 uppercase tracking-tighter">
      ...
      <div className="absolute top-10 right-10 text-right">
        <div className="mono text-[10px] font-black text-[#FF2C2C] uppercase tracking-widest mb-1">Survey_Scan</div>
        <div className="mono text-[8px] text-white/20 uppercase tracking-tighter tabular-nums">
          LAT: 00.000000<br />
          LNG: 00.000000<br />
          ELV: --.---
        </div>
      ...
      <div className="absolute bottom-10 left-10 opacity-30">
        <div className="mono text-[8px] text-white/40 space-y-1">
